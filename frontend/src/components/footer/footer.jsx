      ...
      <div className="footer-container">
        <div className="personal-links">
          ...
          <div className="links">
            ...
            <div><a target="_blank" href="https://angel.co/kaiyip-ho" className="fa-angellist"><img className="angel-border" src="https://image.flaticon.com/icons/svg/2111/2111326.svg" width="30px" /><span className="label">AngelList</span></a></div>
          </div>
        </div>
        ...
        <div className="personal-links">
          ...
          <div className="links">
            ...
            <div><a target="_blank" href="https://angel.co/paul-tan-00" className="fa-angellist"><img className="angel-border" src="https://image.flaticon.com/icons/svg/2111/2111326.svg" width="30px" /><span className="label">AngelList</span></a></div>
          </div>
        </div>
        ...
        <div className="personal-links">
          ...
          <div className="links">
            ...
            <div><a target="_blank" href="https://angel.co/rich-lim" className="fa-angellist"><img className="angel-border" src="https://image.flaticon.com/icons/svg/2111/2111326.svg" width="30px" /><span className="label">AngelList</span></a></div>
          </div>
        </div>
        ...
        <div className="personal-links">
          ...
          <div className="links">
            ...
            <div><a target="_blank" href="https://angel.co/rob_romano" className="fa-angellist"><img className="angel-border" src="https://image.flaticon.com/icons/svg/2111/2111326.svg" width="30px" /><span className="label">AngelList</span></a></div>
          </div>
        </div>
      </div>
    )
